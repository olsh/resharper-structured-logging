...
namespace ReSharper.Structured.Logging.Tests.Analyzer
{
    ...
    public class ZLoggerV2AnalyzerTests : MessageTemplateAnalyzerTestBase
    {
        ...
        [Test]
        public void TestInvalidNamedProperty() => DoNamedTest2();

        [Test]
        public void TestExplicitNameInvalidProperty() => DoNamedTest2();

        // The name ends at the first colon after the '@', the rest is the real format
        [Test]
        public void TestExplicitNameWithFormat() => DoNamedTest2();

        // ':json' is a format, not a name, so the hole keeps the name of its expression
        [Test]
        public void TestJsonFormatKeepsName() => DoNamedTest2();

        [Test]
        public void TestAlignmentIgnored() => DoNamedTest2();

        [Test]
        public void TestDuplicateProperties() => DoNamedTest2();

        // A hole named after a complex expression is left out of the naming rules but still counts
        // as a duplicate
        [Test]
        public void TestDuplicatePropertiesFromExpressions() => DoNamedTest2();

        [Test]
        public void TestMessageIsSentence() => DoNamedTest2();

        [Test]
        public void TestAllLogLevels() => DoNamedTest2();
        ...
        [Test]
        public void TestTemplateIsCompileTimeConstant() => DoNamedTest2();
        ...
        [Test]
        public void TestComplexExpressionNotChecked() => DoNamedTest2();
        ...
        [Test]
        public void TestPositionalPropertyNotReported() => DoNamedTest2();
        ...
        [Test]
        public void TestExceptionInContextArgument() => DoNamedTest2();

        [Test]
        public void TestExceptionInTemplateHole() => DoNamedTest2();

        // Nor is the text of an exception read inside a hole, for the same reason
        [Test]
        public void TestExceptionMessageInTemplateHole() => DoNamedTest2();

        [Test]
        public void TestExceptionOverload() => DoNamedTest2();
        ...
        [Test]
        public void TestComplexObjectNoDestructuring() => DoNamedTest2();

        // The '@' of an explicit ZLogger name is not a destructuring operator, so a scalar hole is not redundant
        [Test]
        public void TestScalarExplicitNameNotRedundant() => DoNamedTest2();
    }
}
